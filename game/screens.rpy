...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Guardados {}"), auto=_("Automaticos"), quick=_("Guardado Rapido"))
        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("Pantalla") action Preference("display", "fullscreen")

                vbox:
                    style_prefix "check"
                    label _("Saltar")
                    textbutton _("Texto Leido") action Preference("skip", "toggle")
                    textbutton _("Despues de decidir") action Preference("after choices", "toggle")
                    textbutton _("Trancisiones") action InvertSelected(Preference("transitions", "toggle"))
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Velocidad en Automatico")
